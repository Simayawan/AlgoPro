def strtup(tuple, string): # defines the function
    ...
    for x in range(len(string)): # the range function turns the string into a range of numbers starting from 0 until the amount of letters (but minus 1 from the actual length of the string) there are in the word.
